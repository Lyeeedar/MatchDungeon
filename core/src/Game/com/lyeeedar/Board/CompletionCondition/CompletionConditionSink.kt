...
class CompletionConditionSinkData : AbstractCompletionConditionData()
{
	...
	/* Autogenerated method contents. Do not modify. */
		super.load(xmlData)
		count = xmlData.getInt("Count", 5)
	}
}

class CompletionConditionSink(data: CompletionConditionSinkData) : AbstractCompletionCondition<CompletionConditionSinkData>(data)
{
	...
	override fun getDescription(grid: Grid) : Table
	{
		...
		table.add(Label(split[0] + "$actualCount", Statics.skin))

...
class SpreaderData : XmlDataClass()
{
	...
	/* Autogenerated method contents. Do not modify. */
		...
		spriteWrapper = AssetManager.tryLoadSpriteWrapper(xmlData.getChildByName("Sprite"))
		particleEffect = AssetManager.tryLoadParticleEffect(xmlData.getChildByName("ParticleEffect"))?.getParticleEffect()
		effect = SpreaderEffect.valueOf(xmlData.get("Effect", SpreaderEffect.SEAL.toString())!!.toUpperCase(Locale.ENGLISH))
